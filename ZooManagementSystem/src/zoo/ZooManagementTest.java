...
public class ZooManagementTest {
	...
	public void zooManagementTest() {
		...
		assertEquals(false,zoomanager.addAnimal("sher", 12, 12,"Lion","Mammal"));
		...
		assertEquals(false,zoomanager.zoneList.get(0).addCage(1, "Snake"));
